...
/* package brainfuck-interpreter-0.1.0.1 */
#ifndef VERSION_brainfuck_interpreter
#define VERSION_brainfuck_interpreter "0.1.0.1"
#endif /* VERSION_brainfuck_interpreter */
#ifndef MIN_VERSION_brainfuck_interpreter
#define MIN_VERSION_brainfuck_interpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_brainfuck_interpreter */
...
#define CURRENT_COMPONENT_ID "brainfuck-interpreter-0.1.0.1-inplace-brainfuck-parser"
